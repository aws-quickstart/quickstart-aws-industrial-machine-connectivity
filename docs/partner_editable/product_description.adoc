...
//TODO Marcia, Can you compare the text in this section with the text of the same section in the following link. It seems to me that the following link has more details which is important to keep. https://aws-quickstart.github.io/quickstart-aws-industrial-machine-connectivity/#_industrial_machine_connectivity_on_aws
...
//TODO Shivansh, Please supply the source file that Figure 1 was generated from. - I have asked Thomas for the source file. I'll attach it to the sim as soon as I have it.
