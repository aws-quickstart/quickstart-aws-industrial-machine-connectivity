...
LICENSE.txt
    	...
    	README.md
....
//TODO Shivansh, In the generated guide, Table 7 and Table 10 repeat the same parameters ("AWS Quick Start Configuration"). How do we eliminate that duplication?