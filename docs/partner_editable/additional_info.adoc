...
The configuration steps you follow after deploying this Quick Start depend on which deployment option you chose. Follow the steps documented in the appropriate guide:
...
....
//TODO Shivansh, This service name—AWS IoT SiteWise—"must always include 'AWS' in any content platform." Please make sure that this name is cited fully throughout the code, including comments. Then update any lines we quote in the docs, such as those above. (As needed, change "a" to "an" too.)
...
LICENSE.txt
    	...
    	README.md
....
//TODO Shivansh, Table 7 and Table 10 describe the same parameters. We don't want that duplication, do we?